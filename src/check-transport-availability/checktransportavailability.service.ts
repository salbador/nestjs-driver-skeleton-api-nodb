...
export class CheckTransportAvailabilityService {
    CheckTransportAvailability: ITempletu[] = [
        { id: '1', 
        lastName: "John",
        firstName: "Doe", 
    ...
    getCheckTransportAvailability(): ITempletu[] {
        return this.CheckTransportAvailability
    }

    getTempletu(id: string): ITempletu {
        const foundedTempletu = this.CheckTransportAvailability.find(templetu => templetu.id === id)
        return foundedTempletu
    }

    createTempletu(templetuDTO: TempletuDTO): ITempletu {
        this.CheckTransportAvailability.push(templetuDTO)
        return templetuDTO
    }
    ...
    deleteTempletu(id: string) {
        this.CheckTransportAvailability = this.CheckTransportAvailability.filter(templetu => templetu.id !== id)
    }
}
