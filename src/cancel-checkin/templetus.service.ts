...
export class TempletusService {
    ...
    getTempletus(): ITempletu[] {
        return this.Templetus
    }

    getTempletu(id: string): ITempletu {
        const foundedTempletu = this.Templetus.find(templetu => templetu.id === id)
        return foundedTempletu
    }

    createTempletu(templetuDTO: TempletuDTO): ITempletu {
        this.Templetus.push(templetuDTO)
        return templetuDTO
    }
    ...
    deleteTempletu(id: string) {
        this.Templetus = this.Templetus.filter(templetu => templetu.id !== id)
    }
}
