...
export class PrintDocumentsService {
    ...
    getTempletu(id: string): ITempletu {
        const foundedTempletu = this.PrintDocuments.find(templetu => templetu.id === id)
        return foundedTempletu
    }

    createTempletu(templetuDTO: TempletuDTO): ITempletu {
        this.PrintDocuments.push(templetuDTO)
        return templetuDTO
    }
    ...
    deleteTempletu(id: string) {
        this.PrintDocuments = this.PrintDocuments.filter(templetu => templetu.id !== id)
    }
}
