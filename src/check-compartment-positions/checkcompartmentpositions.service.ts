...
export class CheckCompartmentPositionsService {
    CheckCompartmentPositions: ITempletu[] = [
        { id: '1', 
        lastName: "John",
        firstName: "Doe", 
    ...
    getCheckCompartmentPositions(): ITempletu[] {
        return this.CheckCompartmentPositions
    }

    getTempletu(id: string): ITempletu {
        const foundedTempletu = this.CheckCompartmentPositions.find(templetu => templetu.id === id)
        return foundedTempletu
    }

    createTempletu(templetuDTO: TempletuDTO): ITempletu {
        this.CheckCompartmentPositions.push(templetuDTO)
        return templetuDTO
    }
    ...
    deleteTempletu(id: string) {
        this.CheckCompartmentPositions = this.CheckCompartmentPositions.filter(templetu => templetu.id !== id)
    }
}
