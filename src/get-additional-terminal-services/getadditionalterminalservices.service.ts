...
export class GetAdditionalTerminalServicesService {
    GetAdditionalTerminalServices: ITempletu[] = [
        { id: '1', 
        lastName: "John",
        firstName: "Doe", 
    ...
    getGetAdditionalTerminalServices(): ITempletu[] {
        return this.GetAdditionalTerminalServices
    }

    getTempletu(id: string): ITempletu {
        const foundedTempletu = this.GetAdditionalTerminalServices.find(templetu => templetu.id === id)
        return foundedTempletu
    }

    createTempletu(templetuDTO: TempletuDTO): ITempletu {
        this.GetAdditionalTerminalServices.push(templetuDTO)
        return templetuDTO
    }
    ...
    deleteTempletu(id: string) {
        this.GetAdditionalTerminalServices = this.GetAdditionalTerminalServices.filter(templetu => templetu.id !== id)
    }
}
