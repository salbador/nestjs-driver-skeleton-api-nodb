...
export class GetTerminalShiftsService {
    ...
    getGetTerminalShifts(): ITempletu[] {
        return this.GetTerminalShifts
    }

    getTempletu(id: string): ITempletu {
        const foundedTempletu = this.GetTerminalShifts.find(templetu => templetu.id === id)
        return foundedTempletu
    }

    createTempletu(templetuDTO: TempletuDTO): ITempletu {
        this.GetTerminalShifts.push(templetuDTO)
        return templetuDTO
    }
    ...
    deleteTempletu(id: string) {
        this.GetTerminalShifts = this.GetTerminalShifts.filter(templetu => templetu.id !== id)
    }
}
