...
export class CheckAdditionalInformationService {
    CheckAdditionalInformation: ITempletu[] = [
        { id: '1', 
        lastName: "John",
        firstName: "Doe", 
    ...
    getCheckAdditionalInformation(): ITempletu[] {
        return this.CheckAdditionalInformation
    }

    getTempletu(id: string): ITempletu {
        const foundedTempletu = this.CheckAdditionalInformation.find(templetu => templetu.id === id)
        return foundedTempletu
    }

    createTempletu(templetuDTO: TempletuDTO): ITempletu {
        this.CheckAdditionalInformation.push(templetuDTO)
        return templetuDTO
    }
    ...
    deleteTempletu(id: string) {
        this.CheckAdditionalInformation = this.CheckAdditionalInformation.filter(templetu => templetu.id !== id)
    }
}
